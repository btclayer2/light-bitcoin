...
pub fn h256_reverse(mut hash: H256) -> H256 {
...
mod tests {
    ...
    #[test]
    fn test_reverse_h256() {
        let hash = H256::from([
            0x63, 0xfc, 0x3a, 0xef, 0xc8, 0x2d, 0x1a, 0xff, 0x15, 0x7c, 0x9e, 0x4c, 0x6b, 0x6d,
            0x95, 0x7e, 0xbf, 0xc4, 0x0c, 0xdd, 0xc9, 0xbe, 0x0c, 0x77, 0x67, 0x3c, 0xc4, 0x6c,
            0x6a, 0x4a, 0x6a, 0xc1,
        ]);
        let reverse_hash = h256_reverse(hash);
        assert_eq!(
            h256_from_rev_str("63fc3aefc82d1aff157c9e4c6b6d957ebfc40cddc9be0c77673cc46c6a4a6ac1"),
            reverse_hash
        );
    }
}
